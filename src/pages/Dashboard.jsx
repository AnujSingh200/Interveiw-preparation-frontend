        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
          {sessions.map((s) => (
            <div
              ...
              className="bg-white p-5 rounded-2xl shadow-sm border hover:shadow-md hover:scale-[1.02] transition cursor-pointer relative"
            >
              ...
              <button
                ...
                className="absolute top-3 right-3 text-red-400 hover:text-red-600 text-lg transition"
              >
                🗑️
              </button>
            </div>
